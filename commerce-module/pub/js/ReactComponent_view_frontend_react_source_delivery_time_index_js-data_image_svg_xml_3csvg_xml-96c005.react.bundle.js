 ...
 */
(self["webpackChunkmagento_react"] = self["webpackChunkmagento_react"] || []).push([["ReactComponent_view_frontend_react_source_delivery_time_index_js-data_image_svg_xml_3csvg_xml-96c005"],{

/***/ "../ReactComponent/view/frontend/react_source/delivery_time/deliveryLabel.js":
/*!***********************************************************************************!*\
  !*** ../ReactComponent/view/frontend/react_source/delivery_time/deliveryLabel.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ DeliveryLabel)\n/* harmony export */ });\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ \"./node_modules/react/index.js\");\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var react_bootstrap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-bootstrap */ \"./node_modules/react-bootstrap/esm/Spinner.js\");\n\n\n\n// import styled from \"styled-components\";\n\nclass DeliveryLabel extends react__WEBPACK_IMPORTED_MODULE_0__.Component {\n  constructor(props) {\n    super(props);\n    console.log(\"props in delivery\", props);\n    this.state = {\n      date1: \"\",\n      loading: true,\n      spinner: false,\n      isFailed: false\n    };\n  }\n  checkDeliveryTime = date1 => {\n    let datetemp = date1.split(\"T\");\n    this.setState({\n      date1: datetemp[0],\n      loading: false,\n      spinner: false,\n      isFailed: false\n    });\n  };\n  async componentDidMount() {\n    const {\n      country,\n      zipCode,\n      itemId,\n      requiredQty,\n      webhookAccessToken,\n      webhookURL,\n      ibmOrganizationId\n    } = this.props;\n    console.log(webhookAccessToken);\n    this.setState({\n      spinner: true\n    });\n    const data = {\n      ShipToAddress: {\n        Country: country,\n        ZipCode: zipCode\n      },\n      ItemID: itemId,\n      RequiredQty: requiredQty\n    };\n    const url = webhookURL + \"deliveryTimeWebhook\";\n    const request = await fetch(url, {\n      method: \"POST\",\n      headers: {\n        Authorization: \"Bearer \" + webhookAccessToken,\n        \"Content-Type\": \"application/json\",\n        \"x-gw-ims-org-id\": ibmOrganizationId\n      },\n      body: JSON.stringify(data)\n    });\n    const result = await request.json();\n    if (result.SuggestedOption.Option) {\n      let deliveryDate = result.SuggestedOption.Option.Interactions.Interaction[0].DeliveryDate;\n      this.checkDeliveryTime(deliveryDate);\n    } else if (result.SuggestedOptionUnavailableLines) {\n      this.setState({\n        loading: false,\n        spinner: false,\n        isFailed: true\n      });\n    } else {\n      this.setState({\n        loading: false,\n        spinner: false,\n        isFailed: true\n      });\n    }\n  }\n  render() {\n    console.log(\"statte\", this.state);\n    const styles = {\n      textStyle: {\n        fontSize: 16,\n        fontWeight: \"bold\"\n      }\n    };\n    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(\"div\", null, this.state.isFailed ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(\"h9\", {\n      style: {\n        textAlign: \"left\"\n      }\n    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(\"div\", {\n      style: {\n        fontSize: 12,\n        fontWeight: \"bold\",\n        color: \"red\"\n      }\n    }, \"Could't find product or problem getting delivery date.\")) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(\"h6\", {\n      style: {\n        textAlign: \"left\"\n      }\n    }, !this.state.loading && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(\"div\", {\n      style: styles.textStyle\n    }, \"Order now to get it by \", this.state.date1, \".\"), this.state.spinner && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__[\"default\"], {\n      animation: \"border\"\n    })));\n  }\n}\n\n//# sourceURL=webpack://magento-react/../ReactComponent/view/frontend/react_source/delivery_time/deliveryLabel.js?");

/***/ }),

/***/ "../ReactComponent/view/frontend/react_source/delivery_time/index.js":
/*!***************************************************************************!*\
  !*** ../ReactComponent/view/frontend/react_source/delivery_time/index.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ DeliveryTime)\n/* harmony export */ });\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ \"./node_modules/react/index.js\");\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _deliveryLabel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./deliveryLabel */ \"../ReactComponent/view/frontend/react_source/delivery_time/deliveryLabel.js\");\n/* harmony import */ var react_bootstrap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-bootstrap */ \"./node_modules/react-bootstrap/esm/Button.js\");\n/* harmony import */ var bootstrap_dist_css_bootstrap_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! bootstrap/dist/css/bootstrap.css */ \"./node_modules/bootstrap/dist/css/bootstrap.css\");\n\n\n\n\n\n// import styled from \"styled-components\";\n\nclass DeliveryTime extends react__WEBPACK_IMPORTED_MODULE_0__.Component {\n  constructor(props) {\n    super(props);\n    this.state = {\n      componentActive: false\n    };\n  }\n  render() {\n    const {\n      componentActive\n    } = this.state;\n    const {\n      country,\n      zipCode,\n      itemId,\n      requiredQty,\n      webhookAccessToken,\n      webhookURL,\n      ibmOrganizationId,\n      buttonColor\n    } = this.props;\n    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(\"div\", {\n      style: {\n        content: \"\",\n        display: \"table\",\n        clear: \"both\",\n        border: 0,\n        borderWidth: 0,\n        borderColor: \"gray\",\n        borderStyle: \"solid\",\n        width: \"100%\"\n      }\n    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(\"div\", {\n      style: {\n        float: \"left\"\n      }\n    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__[\"default\"], {\n      variant: \"link\"\n      // style={{ backgroundColor: buttonColor }}\n      ,\n      onClick: () => this.setState({\n        componentActive: true\n      })\n    }, \"Get Delivery Date\")), componentActive && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(\"div\", {\n      style: {\n        float: \"left\",\n        width: \"70%\",\n        padding: \"10px\"\n      }\n    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_deliveryLabel__WEBPACK_IMPORTED_MODULE_1__[\"default\"], {\n      webhookURL: webhookURL,\n      ibmOrganizationId: ibmOrganizationId,\n      itemId: itemId,\n      country: country,\n      zipCode: zipCode,\n      requiredQty: requiredQty,\n      webhookAccessToken: webhookAccessToken\n    })));\n  }\n}\n\n//# sourceURL=webpack://magento-react/../ReactComponent/view/frontend/react_source/delivery_time/index.js?");
...
eval("module.exports = \"data:image/svg+xml,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%27-4 -4 8 8%27%3e%3ccircle r=%272%27 fill=%27%23fff%27/%3e%3c/svg%3e\";\n\n//# sourceURL=webpack://magento-react/data:image/svg+xml,%253csvg_xmlns=%2527http://www.w3.org/2000/svg%2527_viewBox=%2527-4_-4_8_8%2527%253e%253ccircle_r=%25272%2527_fill=%2527%2523fff%2527/%253e%253c/svg%253e?");
...
eval("module.exports = \"data:image/svg+xml,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%27-4 -4 8 8%27%3e%3ccircle r=%273%27 fill=%27%2386b7fe%27/%3e%3c/svg%3e\";\n\n//# sourceURL=webpack://magento-react/data:image/svg+xml,%253csvg_xmlns=%2527http://www.w3.org/2000/svg%2527_viewBox=%2527-4_-4_8_8%2527%253e%253ccircle_r=%25273%2527_fill=%2527%252386b7fe%2527/%253e%253c/svg%253e?");
...
eval("module.exports = \"data:image/svg+xml,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%27-4 -4 8 8%27%3e%3ccircle r=%273%27 fill=%27%23fff%27/%3e%3c/svg%3e\";\n\n//# sourceURL=webpack://magento-react/data:image/svg+xml,%253csvg_xmlns=%2527http://www.w3.org/2000/svg%2527_viewBox=%2527-4_-4_8_8%2527%253e%253ccircle_r=%25273%2527_fill=%2527%2523fff%2527/%253e%253c/svg%253e?");
...
eval("module.exports = \"data:image/svg+xml,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%27-4 -4 8 8%27%3e%3ccircle r=%273%27 fill=%27rgba%280, 0, 0, 0.25%29%27/%3e%3c/svg%3e\";\n\n//# sourceURL=webpack://magento-react/data:image/svg+xml,%253csvg_xmlns=%2527http://www.w3.org/2000/svg%2527_viewBox=%2527-4_-4_8_8%2527%253e%253ccircle_r=%25273%2527_fill=%2527rgba%25280,_0,_0,_0.25%2529%2527/%253e%253c/svg%253e?");
...
eval("module.exports = \"data:image/svg+xml,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%27-4 -4 8 8%27%3e%3ccircle r=%273%27 fill=%27rgba%28255, 255, 255, 0.25%29%27/%3e%3c/svg%3e\";\n\n//# sourceURL=webpack://magento-react/data:image/svg+xml,%253csvg_xmlns=%2527http://www.w3.org/2000/svg%2527_viewBox=%2527-4_-4_8_8%2527%253e%253ccircle_r=%25273%2527_fill=%2527rgba%2528255,_255,_255,_0.25%2529%2527/%253e%253c/svg%253e?");
...
eval("module.exports = \"data:image/svg+xml,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 16 16%27 fill=%27%23fff%27%3e%3cpath d=%27M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z%27/%3e%3c/svg%3e\";\n\n//# sourceURL=webpack://magento-react/data:image/svg+xml,%253csvg_xmlns=%2527http://www.w3.org/2000/svg%2527_viewBox=%25270_0_16_16%2527_fill=%2527%2523fff%2527%253e%253cpath_d=%2527M4.646_1.646a.5.5_0_0_1_.708_0l6_6a.5.5_0_0_1_0_.708l-6_6a.5.5_0_0_1-.708-.708L10.293_8_4.646_2.354a.5.5_0_0_1_0-.708z%2527/%253e%253c/svg%253e?");
...
eval("module.exports = \"data:image/svg+xml,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 30 30%27%3e%3cpath stroke=%27rgba%28255, 255, 255, 0.55%29%27 stroke-linecap=%27round%27 stroke-miterlimit=%2710%27 stroke-width=%272%27 d=%27M4 7h22M4 15h22M4 23h22%27/%3e%3c/svg%3e\";\n\n//# sourceURL=webpack://magento-react/data:image/svg+xml,%253csvg_xmlns=%2527http://www.w3.org/2000/svg%2527_viewBox=%25270_0_30_30%2527%253e%253cpath_stroke=%2527rgba%2528255,_255,_255,_0.55%2529%2527_stroke-linecap=%2527round%2527_stroke-miterlimit=%252710%2527_stroke-width=%25272%2527_d=%2527M4_7h22M4_15h22M4_23h22%2527/%253e%253c/svg%253e?");
...
eval("module.exports = \"data:image/svg+xml,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 30 30%27%3e%3cpath stroke=%27rgba%2833, 37, 41, 0.75%29%27 stroke-linecap=%27round%27 stroke-miterlimit=%2710%27 stroke-width=%272%27 d=%27M4 7h22M4 15h22M4 23h22%27/%3e%3c/svg%3e\";\n\n//# sourceURL=webpack://magento-react/data:image/svg+xml,%253csvg_xmlns=%2527http://www.w3.org/2000/svg%2527_viewBox=%25270_0_30_30%2527%253e%253cpath_stroke=%2527rgba%252833,_37,_41,_0.75%2529%2527_stroke-linecap=%2527round%2527_stroke-miterlimit=%252710%2527_stroke-width=%25272%2527_d=%2527M4_7h22M4_15h22M4_23h22%2527/%253e%253c/svg%253e?");
...
eval("module.exports = \"data:image/svg+xml,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 8 8%27%3e%3cpath fill=%27%23198754%27 d=%27M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z%27/%3e%3c/svg%3e\";\n\n//# sourceURL=webpack://magento-react/data:image/svg+xml,%253csvg_xmlns=%2527http://www.w3.org/2000/svg%2527_viewBox=%25270_0_8_8%2527%253e%253cpath_fill=%2527%2523198754%2527_d=%2527M2.3_6.73.6_4.53c-.4-1.04.46-1.4_1.1-.8l1.1_1.4_3.4-3.8c.6-.63_1.6-.27_1.2.7l-4_4.6c-.43.5-.8.4-1.1.1z%2527/%253e%253c/svg%253e?");
